    ...
    <div class="grid md:grid-cols-2 gap-8 mb-12">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100">
            ...
            <p class="text-gray-600 leading-relaxed mb-4 text-lg">
                เป็นหน่วยงานภายใต้การกำกับดูแลของรัฐมนตรีว่าการกระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม 
                มุ่งเน้นการให้บริการและกำหนดมาตรฐานที่เกี่ยวข้องกับการ <b>วัด การรายงาน และการทวนสอบ (MRV)</b>
            </p>
            <p class="text-gray-600 leading-relaxed text-lg">
                ให้การรับรองปริมาณการปล่อย การลด และการชดเชยก๊าซเรือนกระจก เพื่อพาประเทศไทยกำสังคมสู่การปล่อยคาร์บอนเป็นศูนย์หรือ Net Zero
            </p>
        </div>
